              ...
              var savelocations = new SavedLocations
                {
                    ...
                    Image = result_venues.response.venues[i].categories[0].icon.prefix+ result_venues.response.venues[i].categories[0].icon.suffix,
                    Latitude = result_venues.response.venues[i].location.lat,
                    Longitude = result_venues.response.venues[i].location.lng,
                };
